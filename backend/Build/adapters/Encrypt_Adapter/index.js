...
var EncryptPassword = /*#__PURE__*/function (_EncryptInterface) {
  ...
  function EncryptPassword(Encrypt) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "ComparePassword", function (hashPassword, password) {
      var valid = _this.encrypter.compareSync(password, hashPassword);

      return valid;
    });
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "EncryptUserPassword", function (password) {
    ...
    if (_classStaticPrivateFieldSpecGet(EncryptPassword, EncryptPassword, _instance)) {
      return (0, _possibleConstructorReturn2["default"])(_this, _classStaticPrivateFieldSpecGet(EncryptPassword, EncryptPassword, _instance));
    }

    _classStaticPrivateFieldSpecSet(EncryptPassword, EncryptPassword, _instance, (0, _assertThisInitialized2["default"])(_this));
