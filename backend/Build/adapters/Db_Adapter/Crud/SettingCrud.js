...
var SettingCrud = /*#__PURE__*/function (_CrudInterface) {
  ...
  function SettingCrud(Model) {
    ...
    if (_classStaticPrivateFieldSpecGet(SettingCrud, SettingCrud, _instance)) {
      return (0, _possibleConstructorReturn2["default"])(_this, _classStaticPrivateFieldSpecGet(SettingCrud, SettingCrud, _instance));
    }

    _classStaticPrivateFieldSpecSet(SettingCrud, SettingCrud, _instance, (0, _assertThisInitialized2["default"])(_this));
