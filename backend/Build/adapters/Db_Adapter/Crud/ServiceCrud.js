...
var ServiceCrud = /*#__PURE__*/function (_CrudInterface) {
  (0, _inherits2["default"])(ServiceCrud, _CrudInterface);

  var _super = _createSuper(ServiceCrud);

  function ServiceCrud(Model) {
    var _this;

    (0, _classCallCheck2["default"])(this, ServiceCrud);
    _this = _super.call(this);
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "GetPk", /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(idbusiness, pk) {
        var data;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "GetAll", /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(idbusiness) {
        var data;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return _this.Model.findAll(_objectSpread(_objectSpread({}, _this.Config), {}, {
                  where: {
                    idbusiness: idbusiness
                  }
                }));
    ...
    if (_classStaticPrivateFieldSpecGet(ServiceCrud, ServiceCrud, _instance)) {
      return (0, _possibleConstructorReturn2["default"])(_this, _classStaticPrivateFieldSpecGet(ServiceCrud, ServiceCrud, _instance));
    }

    _classStaticPrivateFieldSpecSet(ServiceCrud, ServiceCrud, _instance, (0, _assertThisInitialized2["default"])(_this));
