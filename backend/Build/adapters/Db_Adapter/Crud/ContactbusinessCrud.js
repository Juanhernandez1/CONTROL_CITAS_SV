...
var ContactbusinessCrud = /*#__PURE__*/function (_CrudInterface) {
  (0, _inherits2["default"])(ContactbusinessCrud, _CrudInterface);

  var _super = _createSuper(ContactbusinessCrud);

  function ContactbusinessCrud(Model) {
    var _this;

    (0, _classCallCheck2["default"])(this, ContactbusinessCrud);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                _error$errors$ = _context.t0.errors[0], message = _error$errors$.message, type = _error$errors$.type, path = _error$errors$.path, origin = _error$errors$.origin;
                return _context.abrupt("return", {
                  success: false,
                  message: message,
                  type: type,
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "GetPk", /*#__PURE__*/function () {
      var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(pk) {
        var data;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "Create", /*#__PURE__*/function () {
      var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(obj) {
        var data, _error$errors$2, message, type, path, origin;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "Update", /*#__PURE__*/function () {
      var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(obj) {
        var FieldPk, pk, data, _error$errors$3, message, type, path, origin;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 10:
                ...
                _error$errors$3 = _context4.t0.errors[0], message = _error$errors$3.message, type = _error$errors$3.type, path = _error$errors$3.path, origin = _error$errors$3.origin;
                return _context4.abrupt("return", {
                  success: false,
                  message: message,
                  type: type,
    ...
    if (_classStaticPrivateFieldSpecGet(ContactbusinessCrud, ContactbusinessCrud, _instance)) {
      return (0, _possibleConstructorReturn2["default"])(_this, _classStaticPrivateFieldSpecGet(ContactbusinessCrud, ContactbusinessCrud, _instance));
    }

    _classStaticPrivateFieldSpecSet(ContactbusinessCrud, ContactbusinessCrud, _instance, (0, _assertThisInitialized2["default"])(_this));
  ...
  return ContactbusinessCrud;
}(_CrudInterface2["default"]);

exports["default"] = ContactbusinessCrud;
var _instance = {
  writable: true,
  value: void 0
};