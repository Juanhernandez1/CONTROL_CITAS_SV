...
var AddressCrud = /*#__PURE__*/function (_CrudInterface) {
  (0, _inherits2["default"])(AddressCrud, _CrudInterface);

  var _super = _createSuper(AddressCrud);

  function AddressCrud(Model) {
    var _this;

    (0, _classCallCheck2["default"])(this, AddressCrud);
    ...
    if (_classStaticPrivateFieldSpecGet(AddressCrud, AddressCrud, _instance)) {
      return (0, _possibleConstructorReturn2["default"])(_this, _classStaticPrivateFieldSpecGet(AddressCrud, AddressCrud, _instance));
    }

    _classStaticPrivateFieldSpecSet(AddressCrud, AddressCrud, _instance, (0, _assertThisInitialized2["default"])(_this));
