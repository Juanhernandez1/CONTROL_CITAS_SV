...
var UserCrud = /*#__PURE__*/function (_CrudInterface) {
  ...
  function UserCrud(Model) {
    ...
    if (_classStaticPrivateFieldSpecGet(UserCrud, UserCrud, _instance)) {
      return (0, _possibleConstructorReturn2["default"])(_this, _classStaticPrivateFieldSpecGet(UserCrud, UserCrud, _instance));
    }

    _classStaticPrivateFieldSpecSet(UserCrud, UserCrud, _instance, (0, _assertThisInitialized2["default"])(_this));
