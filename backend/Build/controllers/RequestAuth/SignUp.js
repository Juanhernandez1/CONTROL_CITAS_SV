...
var SignUp = function SignUp(businessCrud, contactbusinessCrud, addressCrud, freedayCrud, settingCrud, userCrud, accessCrud) {
  var _this = this;

  (0, _classCallCheck2["default"])(this, SignUp);
  (0, _defineProperty2["default"])(this, "SignUpBusinessCreateTraditional", /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
      var _req$body, objUsers, obtAccess, objBusiness, obtSetting, objAddres, objContact, UsersBusiness, UsersBusinessAccess, Business, Addess, Setting, Contact, ERDB404;
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              try {
                _req$body = req.body, objUsers = _req$body.objUsers, obtAccess = _req$body.obtAccess, objBusiness = _req$body.objBusiness, obtSetting = _req$body.obtSetting, objAddres = _req$body.objAddres, objContact = _req$body.objContact;
  ...
  (0, _defineProperty2["default"])(this, "SignUpBusinessCreateGoogle", /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
      var _req$body2, objBusiness, obtSetting, objAddres, objContact, GoogleProfiel, objUsers, UsersBusiness, Business, Addess, Setting, Contact, ERDB404;
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              try {
                _req$body2 = req.body, objBusiness = _req$body2.objBusiness, obtSetting = _req$body2.obtSetting, objAddres = _req$body2.objAddres, objContact = _req$body2.objContact;
  ...
  (0, _defineProperty2["default"])(this, "SignUpUsersCreateTraditional", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              try {
                _req$body3 = req.body, objUsers = _req$body3.objUsers, obtAccess = _req$body3.obtAccess;
  ...
  (0, _defineProperty2["default"])(this, "SignUpUserCreateGoogle", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              try {
                _req$body4 = req.body, objUsers = _req$body4.objUsers, obtAccess = _req$body4.obtAccess;
                Users = _this.UserCrud.Create(objUsers);
                obtAccess.iduser = Users.iduser;
                UsersAccess = _this.AccessCrud.Create(objUsers);
                if (UsersAccess.success) res.status(201).send({
  ...
  (0, _defineProperty2["default"])(this, "SignUpUsersCreateFacebook", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              try {
                _req$body5 = req.body, objUsers = _req$body5.objUsers, obtAccess = _req$body5.obtAccess;
                Users = _this.UserCrud.Create(objUsers);
                obtAccess.iduser = Users.iduser;
                UsersAccess = _this.AccessCrud.Create(objUsers);
                if (UsersAccess.success) res.status(201).send({
