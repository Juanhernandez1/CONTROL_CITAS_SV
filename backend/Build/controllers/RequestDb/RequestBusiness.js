    ...
    /*#__PURE__*/ (function () {
      var _ref2 = (0, _asyncToGenerator2['default'])(
        /*#__PURE__*/ _regenerator['default'].mark(function _callee2(req, res) {
          var state, BusinessList, ERDB404;
          return _regenerator['default'].wrap(
              ...
              while (1) {
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return _this.BusinessCrud.GetAllNoPaginate(state);
                  ...
                  case 8:
                    ...
                    ERDB404 = _ErrorMessages['default'].ERDB404;
                    console.log(ERDB404, _context2.t0);
                    res.status(404).send(ERDB404);
    ...
    /*#__PURE__*/ (function () {
      var _ref4 = (0, _asyncToGenerator2['default'])(
        /*#__PURE__*/ _regenerator['default'].mark(function _callee4(req, res) {
          var search, BusinessList, ERDB404;
          return _regenerator['default'].wrap(
              ...
              while (1) {
                switch ((_context4.prev = _context4.next)) {
                  case 0:
                    ...
                    _context4.next = 4;
                    return _this.BusinessCrud.GetLikeNameNoPage(search);

                  case 4:
                    BusinessList = _context4.sent;
                    if (BusinessList.success)
                      res.status(BusinessList.data ? 200 : 204).send(BusinessList);
                    _context4.next = 14;
                    break;
            ...
            function _callee6$(_context6) {
              while (1) {
                switch ((_context6.prev = _context6.next)) {
                  ...
                  case 4:
                    ContactFindEmail = _context6.sent;
            ...
            function _callee9$(_context9) {
              while (1) {
                switch ((_context9.prev = _context9.next)) {
                  ...
                  case 4:
                    BusinessSetting = _context9.sent;
            ...
            function _callee10$(_context10) {
              while (1) {
                switch ((_context10.prev = _context10.next)) {
                  ...
                  case 4:
                    BusinessSetting = _context10.sent;
            ...
            function _callee11$(_context11) {
              while (1) {
                switch ((_context11.prev = _context11.next)) {
                  ...
                  case 4:
                    BusinessAddess = _context11.sent;
            ...
            function _callee12$(_context12) {
              while (1) {
                switch ((_context12.prev = _context12.next)) {
                  ...
                  case 4:
                    BusinessAddess = _context12.sent;
            ...
            function _callee13$(_context13) {
              while (1) {
                switch ((_context13.prev = _context13.next)) {
                  ...
                  case 4:
                    BusinessContact = _context13.sent;
            ...
            function _callee14$(_context14) {
              while (1) {
                switch ((_context14.prev = _context14.next)) {
                  ...
                  case 4:
                    BusinessContact = _context14.sent;
              ...
              while (1) {
                switch ((_context15.prev = _context15.next)) {
                  ...
                  case 8:
                    ...
                    ERDB404 = _ErrorMessages['default'].ERDB404;
                    console.log(ERDB404, _context15.t0);
                    res.status(404).send(ERDB404);
              ...
              while (1) {
                switch ((_context16.prev = _context16.next)) {
                  ...
                  case 8:
                    ...
                    ERDB404 = _ErrorMessages['default'].ERDB404;
                    console.log(ERDB404, _context16.t0);
                    res.status(404).send(ERDB404);
    ...
    /*#__PURE__*/ (function () {
      var _ref19 = (0, _asyncToGenerator2['default'])(
        /*#__PURE__*/ _regenerator['default'].mark(function _callee19(req, res) {
          var _req$params3, id, date, dataList, BusinessSetting, ERDB404;
            ...
            function _callee19$(_context19) {
              while (1) {
                switch ((_context19.prev = _context19.next)) {
                  ...
                  case 8:
                    BusinessSetting = _context19.sent;
                    ...
                    _context19.t0 = res.status(BusinessSetting.data ? 200 : 204);
                    _context19.next = 13;
                    return _this.AppointmentGen.GetHoursAppointment(
            ...
            function _callee20$(_context20) {
              while (1) {
                switch ((_context20.prev = _context20.next)) {
                  ...
                  case 4:
                    BusinessService = _context20.sent;
            ...
            function _callee21$(_context21) {
              while (1) {
                switch ((_context21.prev = _context21.next)) {
                  ...
                  case 4:
                    BusinessService = _context21.sent;
                    if (BusinessService.data[0] === 1) res.status(202).send(BusinessService);
                    else res.status(406).send(BusinessService);
                    _context21.next = 14;
                    break;
