...
var RequestBusiness = function RequestBusiness(businessCrud, contactbusinessCrud, addressCrud, freedayCrud, settingCrud, servicesCrud, appointmentCrud) {
  var _this = this;

  (0, _classCallCheck2["default"])(this, RequestBusiness);
  (0, _defineProperty2["default"])(this, "RequestBusinessGetAll", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessGetLikeName", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _req$params = req.params, search = _req$params.search, page = _req$params.page;
              _context2.next = 4;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessGetPk", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessCreate", /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
      var _req$body, objBusiness, obtSetting, objAddres, objContact, ContactFindEmail, Business, data, BusinessAddess, BusinessContact, BusinessSetting, ERDB404;
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _req$body = req.body, objBusiness = _req$body.objBusiness, obtSetting = _req$body.obtSetting, objAddres = _req$body.objAddres, objContact = _req$body.objContact;
              _context4.next = 4;
            ...
            case 30:
              res.status(409).send(ContactFindEmail.success ? _objectSpread(_objectSpread({}, ContactFindEmail), {}, {
                data: 'mail exists'
              }) : ContactFindEmail);
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessUpdate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              if (Business.data[0] === 1) res.status(202).send(Business);else res.status(406).send(_objectSpread(_objectSpread({}, Business), {}, {
                success: false
              }));
              _context5.next = 13;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessDelete", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessSettingGetPk", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 4:
              ...
              if (BusinessSetting.success) res.status(BusinessSetting.data ? 200 : 204).send(BusinessSetting);
              _context7.next = 13;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessSettingUpdate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 4:
              ...
              if (BusinessSetting.data[0] === 1) res.status(202).send(BusinessSetting);else res.status(406).send(_objectSpread(_objectSpread({}, BusinessSetting), {}, {
                success: false
              }));
              _context8.next = 13;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessAddressGetPk", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessAddressUpdate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 4:
              ...
              if (BusinessAddess.data[0] === 1) res.status(202).send(BusinessAddess);else res.status(406).send(_objectSpread(_objectSpread({}, BusinessAddess), {}, {
                success: false
              }));
              _context10.next = 14;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessContacGetPk", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 4:
              ...
              if (BusinessContact.success) res.status(BusinessContact.data ? 200 : 204).send(BusinessContact);
              _context11.next = 13;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessContactUpdate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 4:
              ...
              if (BusinessContact.data[0] === 1) res.status(202).send(BusinessContact);else res.status(406).send(_objectSpread(_objectSpread({}, BusinessContact), {}, {
                success: false
              }));
              _context12.next = 13;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessServicesGetAll", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessServicesGetPk", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              _context14.prev = 0;
              _req$params2 = req.params, idbusiness = _req$params2.idbusiness, id = _req$params2.id;
              _context14.next = 4;
              return _this.ServicesCrud.GetPk(idbusiness, id);

            case 4:
              BusinessService = _context14.sent;
              if (BusinessService.success) res.status(BusinessService.data ? 200 : 204).send(BusinessService);
              _context14.next = 13;
              break;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessServicesCreate", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee15$(_context15) {
        while (1) {
          switch (_context15.prev = _context15.next) {
            case 0:
              _context15.prev = 0;
              objServices = req.body.objServices;
              _context15.next = 4;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessServicesUpdate", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context16.prev = _context16.next) {
            case 0:
              ...
              objBusiness = req.body;
              _context16.next = 4;
              return _this.ServicesCrud.Update(objBusiness);

            case 4:
              Business = _context16.sent;
              if (Business.data[0] === 1) res.status(202).send(Business);else res.status(406).send(_objectSpread(_objectSpread({}, Business), {}, {
                success: false
              }));
              _context16.next = 13;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessServicesDelete", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessAppointmentGetAll", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessAppointmentGetPk", /*#__PURE__*/function () {
      ...
      return _regenerator["default"].wrap(function _callee19$(_context19) {
        while (1) {
          switch (_context19.prev = _context19.next) {
            case 0:
              _context19.prev = 0;
              _req$body2 = req.body, idappointmen = _req$body2.idappointmen, idbusiness = _req$body2.idbusiness;
              _context19.next = 4;
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessAppointmentDelete", /*#__PURE__*/function () {
  ...
  (0, _defineProperty2["default"])(this, "RequestBusinessResoveSetting", /*#__PURE__*/function () {
